...
const ICONS = {
  ...
  "play-dark": require("../../assets/icons/play-dark.png"),
  "pause-dark": require("../../assets/icons/pause-dark.png"),
  "stop-dark": require("../../assets/icons/stop-dark.png"),
  "chat-dark": require("../../assets/icons/chat-dark.png"),
  "break-dark": require("../../assets/icons/break-dark.png"),
